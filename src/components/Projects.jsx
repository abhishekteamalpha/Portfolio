    ...
    <div className="row d-flex justify-content-center align-items-center">
      {
        project.map((data) => (
          <>
            <div key={data.id} className='my-4  col-md-4 col-lg-3 mx-4 '>
          <div className="card bg-dark text-white" data-aos="flip-right" data-aos-duration="500" style={{width: "18rem",border:'1px solid yellow', boxShadow:'var(--box-shadow)' }}>
